    ...
    <main>
      ...
      <section className="max-w-7xl mx-auto px-4 py-8 md:py-14">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          <div className="bg-[#FFF1D8] rounded-brand p-8 md:p-14 soft-shadow">
          ...
          <div className="lg:pt-8">
            <p className="text-[10px] font-bold tracking-[0.2em] text-cherry mb-4">TROPITWIST DAILY ESSENTIAL</p>
            <h1 className="font-display font-bold text-ink text-6xl md:text-8xl leading-[0.82] tracking-tight">
            ...
            <p className="font-body text-ink/65 text-sm md:text-base leading-relaxed max-w-lg mt-7">
              {product.description}
            </p>
            <div className="flex items-center justify-between border-y border-ink/10 py-5 mt-8 max-w-lg">
              <span>
            ...
            <div className="flex gap-3 mt-6 max-w-lg">
              ...
              <button onClick={() => addToCart(product.id, quantity)} className="flex-1 rounded-full bg-cherry text-cream text-xs font-bold tracking-widest hover:bg-ink transition-colors">
            ...
            <div className="grid grid-cols-3 gap-2 mt-8 max-w-lg">
              {['Soft finish', 'Daily use', 'Cruelty free'].map((item) => (
                <div key={item} className="bg-banana/50 rounded-brand p-3 text-center text-[10px] font-bold tracking-wide">{item}</div>
              ))}
            </div>
          </div>
        </div>
