    ...
    <main>
      <section className="max-w-7xl mx-auto px-4 pt-8 md:pt-12">
        <div className="relative overflow-hidden rounded-brand bg-banana p-8 md:p-14 min-h-[360px]">
          <div className="relative z-10 max-w-xl">
            <p className="text-[10px] font-bold tracking-[0.22em] mb-4">THE TROPITWIST FINDER</p>
            <h1 className="font-display font-bold text-ink text-7xl md:text-[9rem] leading-[0.78] tracking-tight">FIND YOUR<br /><span className="text-cherry">GLOW.</span></h1>
          </div>
          <div className="absolute right-8 top-8 hidden md:block rounded-full border-2 border-cherry bg-cream px-5 py-4 font-display text-3xl text-cherry rotate-6">
            GLOW FINDER
          </div>
          <label className="absolute left-8 right-8 bottom-8 md:left-auto md:right-14 md:bottom-14 md:w-[380px]">
      ...
      <section className="max-w-7xl mx-auto px-4 py-10 md:py-14">
        ...
        {results.length ? (
          ...
          <div className="rounded-brand bg-banana p-12 text-center">
