  ...
  return (
    <label className="relative block w-full md:w-72">
      ...
      <input
        ...
        className="w-full rounded-full border border-ink/15 bg-cream py-3 pl-10 pr-4 text-sm placeholder:text-ink/45 focus:border-cherry focus:outline-none focus:ring-4 focus:ring-cherry/10"
      />
    </label>
  );
}
