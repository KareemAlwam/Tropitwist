...
export default function CampaignBanner() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 pb-16 md:pb-24">
      ...
      <div className="stripe-yellow-tight p-8 md:p-16 flex flex-col justify-end min-h-[430px] relative overflow-hidden">
        ...
        <div className="absolute top-1/2 right-8 -translate-y-1/2 w-44 md:w-56">
          <img
            src={campaign.image}
      ...
      <div className="bg-banana p-8 md:p-16 flex flex-col justify-center">
